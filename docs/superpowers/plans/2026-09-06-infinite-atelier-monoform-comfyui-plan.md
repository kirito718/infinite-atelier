...
```ts
expect(parseDirectorMessage({ protocol: "atelier-monoform", version: 1, source: "monoform", type: "ready" })).toMatchObject({ type: "ready" });
expect(parseDirectorMessage({ protocol: "wrong", version: 1, source: "monoform", type: "ready" })).toBeNull();
expect(parseDirectorMessage({ protocol: "atelier-monoform", version: 2, source: "monoform", type: "ready" })).toBeNull();
expect(isAllowedDirectorEvent({ origin: "http://localhost:3000", source: iframeWindow, data: {} } as MessageEvent, iframeWindow, "http://localhost:3000")).toBe(true);
```
...
- [ ] **Step 3: Implement mapping and clamping helpers**
...
- [ ] **Step 4: Run the focused Node test and verify it passes**
...
- [ ] **Step 3: Implement Pose and Depth render modes**
...
- [ ] **Step 4: Implement the iframe handshake and request correlation**
...
- [ ] **Step 5: Build the embedded studio**
...
- [ ] **Step 3: Add the API-format workflow and registry**
...
- [ ] **Step 4: Write failing adapter tests with injected fetch and WebSocket doubles**
...
- [ ] **Step 3: Implement task store transitions**
...
- [ ] **Step 4: Implement multipart request parsing and input validation**
...
- [ ] **Step 5: Implement asynchronous job orchestration**
...
- [ ] **Step 4: Mount the server API in dev and preview**
...
- [ ] **Step 5: Run the focused test and the server API test**
...
- [ ] **Step 3: Implement metadata and canvas insertion**
...
- [ ] **Step 4: Implement the typed iframe bridge in DirectorPanel**
...
- [ ] **Step 3: Add Compose and environment examples**
...
- [ ] **Step 2: Run the fake-ComfyUI integration flow**
...
- [ ] **Step 3: Run the real browser smoke flow**
...
- [ ] **Step 4: Review security and failure evidence**
